...
uint32_t integrated_navigation::GpchcParser::GetMessageId() const
{
  return 0;
}

const std::string integrated_navigation::GpchcParser::GetMessageName() const
{
  return MESSAGE_NAME;
}

navit_msgs::GpchcPtr integrated_navigation::GpchcParser::ParseAscii(const integrated_navigation::NmeaSentence& sentence) noexcept(false)
{
...
bool integrated_navigation::GpchcParser::WasLastGpsValid() const
{
