#include <integrated_navigation/library/GnssParserLib/parsers/clocksteering.h>
#include <boost/make_shared.hpp>

const std::string integrated_navigation::ClockSteeringParser::MESSAGE_NAME = "CLOCKSTEERING";

uint32_t integrated_navigation::ClockSteeringParser::GetMessageId() const
{
  return 0;
}

const std::string integrated_navigation::ClockSteeringParser::GetMessageName() const
{
  return MESSAGE_NAME;
}

integrated_navigation::ClockSteeringPtr integrated_navigation::ClockSteeringParser::ParseAscii(const integrated_navigation::NovatelSentence& sentence) noexcept(false)
{
  ...
  integrated_navigation::ClockSteeringPtr msg = boost::make_shared<integrated_navigation::ClockSteering>();
