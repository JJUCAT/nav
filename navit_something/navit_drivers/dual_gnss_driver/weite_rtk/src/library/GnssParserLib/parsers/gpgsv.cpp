#include <integrated_navigation/library/GnssParserLib/parsers/gpgsv.h>
#include <boost/make_shared.hpp>

const std::string integrated_navigation::GpgsvParser::MESSAGE_NAME = "GPGSV";

uint32_t integrated_navigation::GpgsvParser::GetMessageId() const
{
  return 0;
}

const std::string integrated_navigation::GpgsvParser::GetMessageName() const
{
  return MESSAGE_NAME;
}

integrated_navigation::GpgsvPtr integrated_navigation::GpgsvParser::ParseAscii(const integrated_navigation::NmeaSentence& sentence) noexcept(false)
{
  ...
  integrated_navigation::GpgsvPtr msg = boost::make_shared<integrated_navigation::Gpgsv>();
