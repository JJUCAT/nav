...
namespace integrated_navigation {
    ...
    void GetExtendedSolutionStatusMessage(uint32_t status,
                                          navit_msgs::NovatelExtendedSolutionStatus &msg);

    void GetNovatelReceiverStatusMessage(uint32_t status,
                                         navit_msgs::NovatelReceiverStatus &receiver_status_msg);
