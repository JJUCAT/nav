#ifndef SRC_SERIAL_UTILS_HPP
#define SRC_SERIAL_UTILS_HPP
...
struct SerialConfig
{
  ...
  SerialConfig(int32_t baud, int32_t data_bits, int32_t stop_bits, Parity parity, bool flow_control,
...
public:
   ...
   */
  virtual Result ReadBytes(std::string& output, size_t max_bytes, int32_t timeout);

  virtual int32_t Write(const std::string& input);
