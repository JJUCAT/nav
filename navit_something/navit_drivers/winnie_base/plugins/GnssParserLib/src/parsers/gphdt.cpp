#include <GnssParserLib/parsers/gphdt.h>
...
uint32_t integrated_navigation::GphdtParser::GetMessageId() const { return 0; }

const std::string integrated_navigation::GphdtParser::GetMessageName() const { return MESSAGE_NAME; }

navit_msgs::GphdtPtr integrated_navigation::GphdtParser::ParseAscii(
    ...
    navit_msgs::GphdtPtr msg = boost::make_shared<navit_msgs::Gphdt>();
