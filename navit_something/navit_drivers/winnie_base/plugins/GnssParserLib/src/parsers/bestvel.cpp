#include <GnssParserLib/parsers/bestvel.h>
...
navit_msgs::NovatelVelocityPtr integrated_navigation::BestvelParser::ParseBinary(const BinaryMessage &bin_msg) noexcept(
    false) {
    ...
    navit_msgs::NovatelVelocityPtr ros_msg = boost::make_shared<navit_msgs::NovatelVelocity>();
...
navit_msgs::NovatelVelocityPtr integrated_navigation::BestvelParser::ParseAscii(
    const NovatelSentence &sentence) noexcept(false) {
    navit_msgs::NovatelVelocityPtr msg = boost::make_shared<navit_msgs::NovatelVelocity>();
    HeaderParser h_parser;
