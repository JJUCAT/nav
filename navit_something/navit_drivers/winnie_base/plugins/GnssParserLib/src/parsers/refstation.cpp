...
#include <GnssParserLib/parsers/refstation.h>
#include <ros/ros.h>
...
navit_msgs::NovatelRefStationPtr RefStationParser::ParseAscii(const NovatelSentence &sentence) noexcept(false) {
    navit_msgs::NovatelRefStationPtr msg = boost::make_shared<navit_msgs::NovatelRefStation>();
