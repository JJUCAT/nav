#include <GnssParserLib/parsers/dual_antenna_heading.h>
...
navit_msgs::NovatelDualAntennaHeadingPtr DualAntennaHeadingParser::ParseBinary(const BinaryMessage &bin_msg) noexcept(
    false) {
    ...
    navit_msgs::NovatelDualAntennaHeadingPtr ros_msg = boost::make_shared<navit_msgs::NovatelDualAntennaHeading>();
...
navit_msgs::NovatelDualAntennaHeadingPtr DualAntennaHeadingParser::ParseAscii(const NovatelSentence &sentence) noexcept(
    false) {
    navit_msgs::NovatelDualAntennaHeadingPtr ros_msg = boost::make_shared<navit_msgs::NovatelDualAntennaHeading>();
