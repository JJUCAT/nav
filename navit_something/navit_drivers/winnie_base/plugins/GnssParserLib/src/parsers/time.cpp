#include <GnssParserLib/parsers/time.h>
...
navit_msgs::TimePtr integrated_navigation::TimeParser::ParseBinary(
    const integrated_navigation::BinaryMessage &msg) noexcept(false) {
...
navit_msgs::TimePtr integrated_navigation::TimeParser::ParseAscii(
