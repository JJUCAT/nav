...
#include <navit_msgs/Trackstat.h>

#include <GnssParserLib/binary_message.h>
#include <GnssParserLib/nmea_sentence.h>
#include <GnssParserLib/novatel_sentence.h>
...
namespace integrated_navigation {
    ...
    public:
         ...
         */
        bool ExtractCompleteMessages(const std::string &input, std::vector<NmeaSentence> &nmea_sentences,
    ...
    private:
         ...
         */
        void FindAsciiSentence(const std::string &sentence, size_t current_idx, size_t &start_idx, size_t &end_idx,
         ...
         */
        bool GetNovatelMessageParts(const std::string &sentence, std::string &message_id,
         ...
         */
        int32_t GetNmeaSentence(const std::string &str, size_t start_idx, std::string &sentence,
         ...
         */
        void VectorizeString(const std::string &str, std::vector<std::string> &vectorized_message,
