...
class BestposParser : public MessageParser<navit_msgs::NovatelPositionPtr> {
   public:
    ...
    navit_msgs::NovatelPositionPtr ParseBinary(const BinaryMessage &bin_msg) noexcept(false) override;

    navit_msgs::NovatelPositionPtr ParseAscii(const NovatelSentence &sentence) noexcept(false) override;
