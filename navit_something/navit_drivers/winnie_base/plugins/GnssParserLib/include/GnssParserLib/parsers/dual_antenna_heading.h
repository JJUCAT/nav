...
class DualAntennaHeadingParser : public MessageParser<navit_msgs::NovatelDualAntennaHeadingPtr> {
   public:
    ...
    navit_msgs::NovatelDualAntennaHeadingPtr ParseBinary(const BinaryMessage &bin_msg) noexcept(false) override;

    navit_msgs::NovatelDualAntennaHeadingPtr ParseAscii(const NovatelSentence &sentence) noexcept(false) override;
