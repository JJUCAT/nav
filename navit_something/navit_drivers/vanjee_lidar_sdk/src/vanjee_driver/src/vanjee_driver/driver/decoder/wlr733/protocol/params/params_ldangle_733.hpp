...
namespace vanjee
{
  namespace lidar
  {
    class Params_LDAngle733 : public ParamsAbstract
    {
      public:
        uint8 NumOfLines;
      ...
      public:
        ...
        virtual void Load(ProtocolBase& protocol)
        {
          ...
          int16* dataH = reinterpret_cast<int16*>(data+VerAngle.size());
          std::copy(dataH,dataH+VerAngle.size(),std::begin(HorAngle));
        }
    };
  }
}