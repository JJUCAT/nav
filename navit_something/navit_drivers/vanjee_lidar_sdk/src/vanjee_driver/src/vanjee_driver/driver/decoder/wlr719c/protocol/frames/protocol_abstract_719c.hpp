...
namespace vanjee
{
  namespace lidar
  {
    class ProtocolAbstract719C:public ProtocolAbstract
    {
      public:
        ProtocolAbstract719C(const std::shared_ptr<CmdClass> sp_cmd,std::shared_ptr<ParamsAbstract> content,uint16 idx = 0,uint32 timestamp = 0,
          uint8 checkType = 1,uint8 type = 1):ProtocolAbstract(checkType,type,{0x19,0x0C},
