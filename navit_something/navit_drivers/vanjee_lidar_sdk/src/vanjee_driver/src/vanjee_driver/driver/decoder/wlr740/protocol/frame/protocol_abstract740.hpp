...
namespace vanjee
{
  namespace lidar
  {
    class ProtocolAbstract740:public ProtocolAbstract
    {
      public:
        ProtocolAbstract740(const std::shared_ptr<CmdClass> sp_cmd,std::shared_ptr<ParamsAbstract> content,uint16 idx = 0,uint32 timestamp = 0,
