#ifndef NAVIT_BT_NAVIGATOR__MOVE_AREA_A2B_SERVER_HPP
#define NAVIT_BT_NAVIGATOR__MOVE_AREA_A2B_SERVER_HPP
...
{
class MoveAreaA2BServer : public ActionServerBase<navit_msgs::AutoDockAction>
{
public:
  //TODO(czk): 所有的aciton name 应该放到一个文件中，方便管理 
  inline static const std::string action_name = "/move_area_a2b_task";

  explicit MoveAreaA2BServer(ros::NodeHandle& nh, std::string xml_string = "")
...
#endif  // NAVIT_BT_NAVIGATOR__MOVE_AREA_A2B_SERVER_HPP
