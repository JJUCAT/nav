...
#include <fg100_mpc_local_planner/systems/robot_dynamics_interface.h>
...
class Controller : public corbo::PredictiveController
{
 public:
     ...
     */
    virtual bool isPoseTrajectoryFeasible(teb_local_planner::CostmapModel* costmap_model, const std::vector<geometry_msgs::Point>& footprint_spec,
