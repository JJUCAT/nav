...
namespace mpc = fg100_mpc_local_planner;
...
void TestMpcOptimNode::start(ros::NodeHandle& nh)
{
    ...
    teb_local_planner::RobotFootprintModelPtr robot_model = fg100_mpc_local_planner::MpcLocalPlannerROS::getRobotFootprintFromParamServer(nh);

    fg100_mpc_local_planner::Controller controller;
