...
void QuadraticFormCostSE2::computeNonIntegralStateTerm(
...
void QuadraticFormCostSE2::computeIntegralStateControlTerm(
    int k, const Eigen::Ref<const Eigen::VectorXd> &x_k,
...
void QuadraticStateCostSE2::computeNonIntegralStateTerm(
    int k, const Eigen::Ref<const Eigen::VectorXd> &x_k,
    Eigen::Ref<Eigen::VectorXd> cost) const {
  assert(!_integral_form);
  assert(cost.size() == getNonIntegralStateTermDimension(k));
...
void QuadraticStateCostSE2::computeIntegralStateControlTerm(
    int k, const Eigen::Ref<const Eigen::VectorXd> &x_k,
    const Eigen::Ref<const Eigen::VectorXd> &u_k,
    Eigen::Ref<Eigen::VectorXd> cost) const {
  assert(_integral_form);
