 ...
 * \param color	Use CV_RGB(red,green,blue) to determine the color.
 */
void AR_EXPORT DrawLine(cv::Mat& image, const Line line,
 ...
 * \param color	Use CV_RGB(red,green,blue) to determine the color.
 */
void AR_EXPORT DrawPoints(cv::Mat& image,
 ...
 */
void AR_EXPORT DrawCircles(cv::Mat& image,
 ...
 * \param color	Use CV_RGB(red,green,blue) to determine the color.
 */
void AR_EXPORT DrawLines(cv::Mat& image,
                            const std::vector<cv::Point>& contour,
                            const cv::Scalar& color = CV_RGB(255, 0, 0));
 ...
 */
void AR_EXPORT DrawCVEllipse(cv::Mat& image, const cv::RotatedRect& ellipse,
 ...
 */
void AR_EXPORT BuildHideTexture(cv::Mat& image, cv::Mat& hide_texture,
 ...
 * coordinate frame.
 */
void AR_EXPORT DrawTexture(cv::Mat& image, cv::Mat& texture, Camera* cam,
