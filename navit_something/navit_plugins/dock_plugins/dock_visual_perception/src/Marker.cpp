...
#include "dock_visual_perception/Marker.h"
#include <opencv2/highgui.hpp>

template class AR_EXPORT dock_visual_perception::MarkerIteratorImpl<dock_visual_perception::Marker>;
template class AR_EXPORT dock_visual_perception::MarkerIteratorImpl<dock_visual_perception::MarkerData>;
template class AR_EXPORT dock_visual_perception::MarkerIteratorImpl<dock_visual_perception::MarkerArtoolkit>;
