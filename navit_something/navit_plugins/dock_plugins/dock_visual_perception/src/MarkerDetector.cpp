#include "dock_visual_perception/MarkerDetector.h"

template class AR_EXPORT dock_visual_perception::MarkerDetector<dock_visual_perception::Marker>;
template class AR_EXPORT dock_visual_perception::MarkerDetector<dock_visual_perception::MarkerData>;
template class AR_EXPORT dock_visual_perception::MarkerDetector<dock_visual_perception::MarkerArtoolkit>;

using namespace std;

namespace dock_visual_perception
{
MarkerDetectorBase::MarkerDetectorBase()
{
  SetMarkerSize();
  SetOptions();
  labeling = NULL;
...
void MarkerDetectorBase::TrackMarkersReset()
{
  _track_markers_clear();
}

void MarkerDetectorBase::TrackMarkerAdd(int id, PointDouble corners[4])
{
...
void MarkerDetectorBase::SetMarkerSize(double _edge_length, int _res,
                                       double _margin)
{
...
void MarkerDetectorBase::SetMarkerSizeForId(unsigned long id,
                                            double _edge_length)
{
  map_edge_length[id] = _edge_length;
}

void MarkerDetectorBase::SetOptions(bool _detect_pose_grayscale)
{
  detect_pose_grayscale = _detect_pose_grayscale;
}

int MarkerDetectorBase::Detect(cv::Mat& image, Camera* cam, bool track,
...
int MarkerDetectorBase::DetectAdditional(cv::Mat& image, Camera* cam,
