...
// In the estimate() function the distance from the node to the goal is calculated. Uncomment there which distance
// calculation you want to use (Euclidean, Manhattan or Chebyshev). Euclidean is more precisly but could slow the
// planner a little bit on long paths.
