...
class GridCollisionChecker
  : public navit_costmap::FootprintCollisionChecker<navit_costmap::Costmap2D *>
{
public:
  /**
...
protected:
  std::vector<navit_costmap::Footprint> oriented_footprints_;
  navit_costmap::Footprint unoriented_footprint_;
  double footprint_cost_;
  bool footprint_is_radius_;
  std::vector<float> angles_;
  double possible_inscribed_cost_{-1};
  //ROS_INFO("SmacPlannerCollisionChecker");
