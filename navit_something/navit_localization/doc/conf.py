...
htmlhelp_basename = 'navit_localizationdoc'
...
latex_documents = [
    (master_doc, 'navit_localization.tex', u'robot\\_localization Documentation',
     u'Tom Moore', 'manual'),
]
...
man_pages = [
    (master_doc, 'navit_localization', u'navit_localization Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'navit_localization', u'navit_localization Documentation',
     author, 'navit_localization', 'One line description of project.',
     'Miscellaneous'),
]
