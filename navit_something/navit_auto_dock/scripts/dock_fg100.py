...
goal.expected_dock_pose.pose.position.x = 3.2
goal.expected_dock_pose.pose.position.y = 0.0
goal.expected_dock_pose.pose.orientation.w = 1.0

goal_ = FinalDockGoal()
goal_.dock_pose.header.frame_id = "odom"
goal_.dock_pose.pose.position.x = 2.5
goal_.dock_pose.pose.position.y = 0.5
