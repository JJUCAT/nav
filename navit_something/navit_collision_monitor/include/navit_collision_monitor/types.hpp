...
#ifndef COLLISION_MONITOR__TYPES_HPP_
#define COLLISION_MONITOR__TYPES_HPP_
...
struct Velocity {
  ...
  inline bool operator<(const Velocity &second) const {
    ...
    const double second_vel =
        second.x * second.x + second.y * second.y + second.tw * second.tw;
...
#endif // COLLISION_MONITOR__TYPES_HPP_
