...
#ifndef COLLISION_MONITOR__COLLISION_DETECTOR_NODE_HPP_
#define COLLISION_MONITOR__COLLISION_DETECTOR_NODE_HPP_
...
public:
  /**
   * @brief Constructor for the collision_monitor::CollisionDetector
   * @param options Additional options to control creation of the node.
   */
  explicit CollisionDetector(ros::NodeHandle &node);
  /**
   * @brief Destructor for the collision_monitor::CollisionDetector
   */
  ~CollisionDetector();
...
#endif // COLLISION_MONITOR__COLLISION_DETECTOR_NODE_HPP_
