...
#ifndef COLLISION_MONITOR__CIRCLE_HPP_
#define COLLISION_MONITOR__CIRCLE_HPP_
...
public:
   ...
   */
  Circle(ros::NodeHandle &node, const std::string &polygon_name,
...
protected:
   ...
   */
  bool getParameters(std::string &polygon_sub_topic,
...
#endif // COLLISION_MONITOR__CIRCLE_HPP_
