...
#ifndef COLLISION_MONITOR__SOURCE_HPP_
#define COLLISION_MONITOR__SOURCE_HPP_
...
public:
   ...
   * source time
   */
  Source(ros::NodeHandle &node, const std::string &source_name,
   ...
   */
  virtual void getData(const ros::Time &curr_time,
...
protected:
   ...
   */
  bool sourceValid(const ros::Time &source_time,
...
#endif // COLLISION_MONITOR__SOURCE_HPP_
