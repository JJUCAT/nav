...
#ifndef NAVIT_BT_NODES__BEHAVIOR_TREE_ENGINE_HPP_
#define NAVIT_BT_NODES__BEHAVIOR_TREE_ENGINE_HPP_
...
public:
  /**
   * @brief A constructor for navit_bt_nodes::BehaviorTreeEngine
   ...
   * @return navit_bt_nodes::BtStatus Status of BT execution
   */
  BtStatus run(
    BT::Tree * tree,
    std::function<void()> onLoop,
    std::function<bool()> cancelRequested,
    double loopTimeout = 50);
...
#endif  // NAVIT_BT_NODES__BEHAVIOR_TREE_ENGINE_HPP_
