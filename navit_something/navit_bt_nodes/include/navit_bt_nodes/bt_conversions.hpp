...
#ifndef NAVIT_BT_NODES__BT_CONVERSIONS_HPP_
#define NAVIT_BT_NODES__BT_CONVERSIONS_HPP_
...
inline geometry_msgs::PoseStamped convertFromString(const StringView key)
{
  ...
  // ROS_DEBUG("MSG geometry_msgs::PoseStamped convertFromString() RUNNING.");
  ...
  if (parts.size() != 9) {
    ...
    pose_stamped.header.stamp = ros::Time(BT::convertFromString<double>(parts[0]));
...
#endif  // NAVIT_BT_NODES__BT_CONVERSIONS_HPP_
