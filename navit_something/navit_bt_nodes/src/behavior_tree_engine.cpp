  ...
  double loopTimeout)
{
  ...
  try {
    ...
    ROS_ERROR("Behavior tree threw exception: %s. Exiting with failure.", ex.what());
...
BT::Tree
BehaviorTreeEngine::createTreeFromText(const std::string & xml_string)
{
