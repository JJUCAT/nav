...
bool LineSegmentTool::callback(navit_rviz_panel::GetPolylines::Request& req, navit_rviz_panel::GetPolylines::Response& res)
{ 
  navit_rviz_panel::Polyline polyline;  // Assuming Polyline is a struct containing a vector of geometry_msgs::Point
