...
bool PolygonSelectionTool::callback(navit_utils::GetSelection::Request& req, navit_utils::GetSelection::Response& res) { 
  for (const auto& polygonGroup : polygons_) {
    navit_utils::PolygonArrayStamped polygonArray;
