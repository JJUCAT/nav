...
public:
    ...
    public:
        ...
        /**
         * @brief Constructor
         * @param[in] _v0 Initial velocity [m/s] 初始速度
         * @param[in] _a0 Initial linear acceleration [m/ss] 加速度
         * @param[in] _vt Target velocity [m/s] 目标速度，想要达到的匀速度
         * @param[in] _vf Terminal velocity [m/s] 终点速度
         * @param[in] _af Terminal acceleration [m/ss] 终点加速度
         */
    ...
    double estimate_non_uniform_driving_time(const ControlParams& control, const double t_max);
